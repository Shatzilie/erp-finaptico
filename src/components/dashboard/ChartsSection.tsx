...
function generateNarrative({
  ...
  if (current != null && previous != null && previous !== 0 && showDelta) {
...
const ChartsSection = ({ data, isLoading }: ChartsSectionProps) => {
  ...
  // Obtener conteo de facturas del último mes
