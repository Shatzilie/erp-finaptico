...
serve(async (req) => {
  ...
  try {
    ...
    if (!revenue_chart_url || !expenses_chart_url || !comparison_chart_url) {
      console.log('❌ Missing chart images');
      throw new Error('Faltan imágenes de las gráficas');
    }
...
<body>
    ...
    <div class="section">
        ...
        <div class="section-content">
            <p>A continuación se presentan las principales métricas financieras de la empresa con comparativa anual:</p>
